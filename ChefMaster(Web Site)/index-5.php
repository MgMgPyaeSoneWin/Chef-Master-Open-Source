  ...
  <div class="main">
    <div class="row-top">
      ...
      <ul class="sf-menu">
          ...
          <li><a href="index-1.php">Courses </a> </li>
          <li><a href="index-2.php">Recipes</a>
            <ul>
          ...
          <li><a href="index-3.php">Calendar</a> </li>
          <li><a href="index-4.php">Chefs</a> </li>
...
<section id="content"><div class="ic">More Website Templates @ TemplateMonster.com. December03, 2012!</div>
  ...
  <div class="main">
    ...
    <div class="box-address">
      <h4>Chef Master Inc.</h4>
      <dl class="address">
        <dt>123 Tawwin Road,<br>
          Uinversity of Computer Studies, YANGON.</dt>
        <dd> <span>Freephone:</span> + 800 559 6580</dd>
...
<footer>
  <div class="main">
    ...
    <div class="policy">Created by Team-2<a href="http://www.templatemonster.com" rel="nofollow"> Chef Master Moblie App's offical website</a> </div>
    <div class="clear"></div>
  </div>
</footer>
</body>
